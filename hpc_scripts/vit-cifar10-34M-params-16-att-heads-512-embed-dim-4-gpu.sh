...
#SBATCH --job-name 34M16HCF                      # Job name
...
#SBATCH --gres=gpu:a100:4					#will run on a 40gb card
...
python main.py --dataset cifar10 --n_channels 3 --embed_dim 512 --n_attention_heads 16 --n_layers 16 --image_size 32 --epochs 5000
...
echo "python cifar10 vit 34M params, 512 embed dim, 16 layers - HPC gpu instance 40gb card instance script execution time: $hours hours, $minutes minutes, $seconds seconds"
