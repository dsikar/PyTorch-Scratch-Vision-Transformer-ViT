...
#SBATCH --job-name 8.5M_8AT                      # Job name
...
python main.py --dataset cifar10 --n_channels 3 --embed_dim 256 --n_attention_heads 8 --n_layers 16 --image_size 32 --epochs 5000
...
echo "python cifar10 vit 8.5M params, 256 embed dim, 16 layers - HPC gpu instance 40gb card instance script execution time: $hours hours, $minutes minutes, $seconds seconds"
