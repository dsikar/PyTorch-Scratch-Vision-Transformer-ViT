...
#SBATCH --job-name gpu80_4n                      # Job name
...
#SBATCH --gres=gpu:a100_80g:4					#will run on a 40gb card
...
echo "python mem_check.py - HPC 4 node gpu instance 80gb card instance memory check script execution time: $hours hours, $minutes minutes, $seconds seconds"
