...
# Vision Transformer Training - vit-cifar10-0.2M-params.sh
#===============================================================================

#SBATCH -D /users/aczd097/git/vit/PyTorch-Scratch-Vision-Transformer-ViT    # Working directory
#SBATCH --job-name 0.2MCF10                                               # Job name (8 characters or less)
...
--patch_size 8 --n_attention_heads 4 --n_layers 6 --image_size 32 --epochs 5000 \
