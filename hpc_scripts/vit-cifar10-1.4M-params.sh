...
# Vision Transformer Training - vit-cifar10-1.4M-params.sh
#===============================================================================

#SBATCH -D /users/aczd097/git/vit/PyTorch-Scratch-Vision-Transformer-ViT    # Working directory
#SBATCH --job-name 1.4MPcf10                                               # Job name (8 characters or less)
...
#SBATCH --partition=gengpu            # Partition choice: gengpu
...
#SBATCH --gres=gpu:a100:1            # Request 1x A100 40GB GPU on gengpu partition
##SBATCH --gres=gpu:a100_80g:1       # Uncomment to request 1x A100 80GB GPU on preemptgpu partition
