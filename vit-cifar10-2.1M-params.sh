...
#SBATCH --job-name 2.1MPcf10                      # Job name
...
python main.py --dataset cifar10 --n_channels 3 --embed_dim 128 --n_attention_heads 4 --n_layers 16 --image_size 32 --epochs 1000
...
echo "python cifar10 vit 1.6M params - HPC gpu instance 40gb card instance script execution time: $hours hours, $minutes minutes, $seconds seconds"
