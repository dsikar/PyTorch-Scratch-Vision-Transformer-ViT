...
#SBATCH --job-name gpu40_1n                      # Job name
...
echo "python mem_check.py - HPC 1 node gpu instance 40gb card instance memory check script execution time: $hours hours, $minutes minutes, $seconds seconds"
