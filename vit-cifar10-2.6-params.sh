...
#SBATCH --job-name 2.6MP2gp                      # Job name
...
python main.py --dataset cifar10 --n_channels 3 --embed_dim 128 --n_attention_heads 4 --n_layers 20 --image_size 32 --epochs 5000
...
echo "python cifar10 vit 2.6 params - HPC gpu instance 40gb card instance script execution time: $hours hours, $minutes minutes, $seconds seconds"
