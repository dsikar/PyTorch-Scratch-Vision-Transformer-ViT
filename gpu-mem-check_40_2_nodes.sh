...
echo "python gpu_mem_check.py - HPC 2 node gpu instance 40gb card instance memory check script execution time: $hours hours, $minutes minutes, $seconds seconds"
