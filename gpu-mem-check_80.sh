...
#SBATCH --job-name gpumem40                      # Job name
...
#SBATCH --gres=gpu:a100_80g:1					#will run on a 40gb card
...
echo "python gpu_mem_check.py - HPC gpu instance 80:gb card instance memory check script execution time: $hours hours, $minutes minutes, $seconds seconds"
