...
#SBATCH --job-name svh_gpu                      # Job name
...
# python main.py --dataset fashionmnist --epochs 1000
python main.py --dataset svhn --n_channels 3 --image_size 32 --embed_dim 128 --epochs 1000
...
echo "python grok original setup - HPC gpu instance 40gb card instance script execution time: $hours hours, $minutes minutes, $seconds seconds"
